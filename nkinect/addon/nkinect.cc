...
//Added for firmware upload. For Kinect 1473
...
explicit NKinect(NKinectInitOptions opts) {
        ...
        //Added to support kinect 1473 firmware. If using other kinect must be removed
        freenect_set_fw_address_nui(this->context, getFWData1473(), getFWSize1473());
        freenect_set_fw_address_k4w(this->context, getFWDatak4w(), getFWSizek4w());
...
NODE_MODULE(nkinect, NKinect::Init)
